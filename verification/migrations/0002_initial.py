# Generated by Django 4.2.4 on 2023-08-22 16:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergies', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=135), size=3)),
                ('suplements_taken', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=135), size=3)),
                ('health_conditions', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=135), size=3)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inspirations', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=135), size=3)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='exercises',
            field=models.ManyToManyField(to='verification.exercise'),
        ),
    ]
